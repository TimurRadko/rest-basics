...
public interface GiftCertificateRepository extends Repository<GiftCertificate> {
     ...
     *
     * @param giftCertificate - passed into the method GiftCertificate that is contained in one
     *                        of all tables in the DB
    ...
    /***
     * Delete GiftCertificate with the specified id
     *
     * @param id - passed into the method id parameter that is contained in one of all tables in the DB
     * @return int - return value more than 0, when GiftCertificate was deleted
     */
    int delete(long id);
}
